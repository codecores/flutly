...
import 'package:flutly/external/modal_bottom_sheet/src/utils/scroll_to_top_status_bar.dart';
                ...
                children: [
                  widget.blur != null
                      ? FlutlyButton(
                          ...
                          child: Blur(
                            blur: widget.blur!,
                            blurColor: widget.blurColor ?? Colors.white,
                            colorOpacity: 0.05,
                            child: const SizedBox.expand(),
                          ).animate(target: isClosing ? 0 : 1).fadeIn(curve: Curves.easeInOut),
                        )
                      : const SizedBox(),
                  SizedBox.expand(
